<h2><a href="https://practice.geeksforgeeks.org/problems/merge-two-bst-s/1?page=1&status[]=unsolved&category[]=Tree&curated[]=1&sortBy=submissions">Merge two BST 's</a></h2><h3>Difficulty Level : Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two BSTs, return elements of both BSTs in <strong>sorted </strong>form.</span></p>
