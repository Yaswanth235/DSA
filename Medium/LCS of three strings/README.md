<h2><a href="https://practice.geeksforgeeks.org/problems/lcs-of-three-strings0028/1?page=2&difficulty[]=1&status[]=unsolved&category[]=Strings&sortBy=submissions">LCS of three strings</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given 3 strings A, B&nbsp;and C, the task is to find the longest common sub-sequence in all three given sequences.</span></p>
